...
if ( ! class_exists( 'WPB_PCF_WeDevs_Settings_API' ) ) :
	...
	class WPB_PCF_WeDevs_Settings_API {
		...
		public function callback_file( $args ) {
			...
			$label = isset( $args['options']['button_label'] ) ? $args['options']['button_label'] : esc_html__( 'Choose File', 'wpb-popup-for-contact-form-7' );
		...
		public function callback_pages( $args ) {
			...
			$html          = wp_dropdown_pages( $dropdown_args ); // WPCS: XSS ok.
			echo $html;
		}
